...
class PaymentMethodsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create payment_method" do
    assert_difference('PaymentMethod.count') do
      post payment_methods_url, params: { payment_method: { order_id: @payment_method.order_id, payable_id: @payment_method.payable_id } }
    end
  ...
  test "should update payment_method" do
    patch payment_method_url(@payment_method), params: { payment_method: { order_id: @payment_method.order_id, payable_id: @payment_method.payable_id } }
