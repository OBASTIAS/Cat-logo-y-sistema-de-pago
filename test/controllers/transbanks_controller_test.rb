...
class TransbanksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create transbank" do
    assert_difference('Transbank.count') do
      post transbanks_url, params: { transbank: { amount: @transbank.amount, method_id: @transbank.method_id } }
    end
  ...
  test "should update transbank" do
    patch transbank_url(@transbank), params: { transbank: { amount: @transbank.amount, method_id: @transbank.method_id } }
