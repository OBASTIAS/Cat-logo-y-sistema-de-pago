class TransbanksController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @transbank.save
        format.html { redirect_to transbank_url(@transbank), notice: "Transbank was successfully created." }
  ...
  def update
    respond_to do |format|
      if @transbank.update(transbank_params)
        format.html { redirect_to transbank_url(@transbank), notice: "Transbank was successfully updated." }
  ...
  private
    ...
    def transbank_params
      params.require(:transbank).permit(:amount, :method_id)
    end
end
