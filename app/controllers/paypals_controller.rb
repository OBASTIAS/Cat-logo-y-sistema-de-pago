class PaypalsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @paypal.save
        format.html { redirect_to paypal_url(@paypal), notice: "Paypal was successfully created." }
  ...
  def update
    respond_to do |format|
      if @paypal.update(paypal_params)
        format.html { redirect_to paypal_url(@paypal), notice: "Paypal was successfully updated." }
